...
function layers = Q3()
    ...
    % ** Your code here **
    % Train the above data using layers for MNIST:
    layersForMNIST = Q1();
    options = trainingOptions('sgdm',...
        'MaxEpochs',10, ...
        'Verbose',true);
    network = trainNetwork(trainDigitData, layersForMNIST, options);
    
    % Transfer the weights to a new network
    newLayers = network.Layers(1:end-3);
